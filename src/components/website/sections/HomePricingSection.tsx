...
import PlansCTAForm from "../forms/PlansCTAForm";
...
const PricingContent = () => (
  <div className="text-center max-w-2xl mx-auto mb-6">
    ...
    <p className="text-muted-foreground">
      Escolha o plano ideal para o seu objetivo. Todos incluem primeira aula
      gratuita!
    </p>
  </div>
);
  ...
  return (
    <section id="investimento" className="default-padding py-20 bg-background">
      <div className="container mx-auto px-4">
        <PricingContent />
        <PlansCTAForm onNomeChange={handleNomeChange} />
        <PricingGrid buildLink={buildLink} />
      </div>
    </section>
  );
}
